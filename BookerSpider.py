...
#            request = Request(url=page,callback=self.barcode_parse, cb_kwargs={'cat_code':i})
#            yield request
#            
...
#
#        # todo - create local mariadb using James's schema from GitHub - and trial scrape to it.
