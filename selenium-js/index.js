...
(async function () {
  ...
  try {
    ...
    // driver.wait(driver.findElement(By.id('LoginControl_CustomerNumberSingle')).sendKeys("303182030", Key.RETURN), 1000)
    driver
      .findElement(By.id("LoginControl_CustomerNumberSingle"))
      .sendKeys("303182030", Key.RETURN);
    // driver.sleep(100000)

    // driver.findElement(By.id("LoginControl_EmailSingle")).sendKeys("drvLNXzExJ6J96zn")

    // driver.wait(driver.findElement(By.id("LoginControl_EmailSingle")).sendKeys("nigelsr@gmail.com"), 5000)
